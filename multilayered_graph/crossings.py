...
def crossings_for_node_pair(ml_graph: MultiLayeredGraph, u: MLGNode, v: MLGNode):
    ...
    u_out_neighbor_idxs = [nodes_to_index[n] for n in ml_graph.nodes_to_out_edges[u]]
    v_out_neighbors_idxs = [nodes_to_index[n] for n in ml_graph.nodes_to_out_edges[v]]
...
def crossings_uv_vu(ml_graph: MultiLayeredGraph, u: MLGNode, v: MLGNode):
    uv = crossings_for_node_pair(ml_graph, u, v)
    vu = crossings_for_node_pair(ml_graph, v, u)
    return uv, vu
