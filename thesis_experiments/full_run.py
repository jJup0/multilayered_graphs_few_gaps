...
def in_dir_name(test_case_name: str):
    ...
    return os.path.realpath(f"{thesis_experiments_dirname}/local_tests/{test_case_name}/in")

def out_csv_path(test_case_name: str):
    # return f"local_tests/{test_case_name}/out.csv"
    return os.path.realpath(f"{thesis_experiments_dirname}/local_tests/{test_case_name}/out.csv")

def log_path(test_case_name: str):
    # return f"local_tests/{test_case_name}/out.csv"
    return os.path.realpath(f"{thesis_experiments_dirname}/local_tests/{test_case_name}/log.txt")
...
def create_graphs(
    ...
    *,
    ...
    print(f"about to generate {graph_gen_count * len(real_node_counts)} graph instances")
...
if __name__ == "__main__":
    ...
    run_sidegaps_batch("testcase_10-50_sidegaps_batched", 
            graph_gen_count=5,
        real_node_counts=[50],
